        ...
        <div className="max-w-5xl mx-auto p-8 bg-gray-100">
          ...
          <div className="flex flex-col md:flex-row items-center mb-10">
            <div className="md:w-1/2 mb-4 md:mb-0">
              <h1 className="text-5xl font-bold mb-4">Heardle</h1>
              <p className="text-xl mb-4">
                Hi I&apos;m Michael, I hope you enjoy the app.
              </p>
              <p className="text-xl">
                If you have any concerns, please contact me on my LinkedIn or Github!
              </p>
            </div>
          ...
          <div className="flex justify-around bg-teal-600 p-4 rounded-xl mb-10">
