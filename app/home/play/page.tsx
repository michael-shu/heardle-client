...
const page = () => {
  ...
  <div className="relative z-10 text-center px-6">
    ...
    <p className="text-lg md:text-2xl">We&aposre crafting something amazing. Stay tuned!</p>
    <p className="text-sm md:text-base mt-4">Thank you for your patience. We&aposll be live soon!</p>
  </div>
</div>
  )
}
